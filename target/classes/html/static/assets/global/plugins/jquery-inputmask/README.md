...
##### com.seckill.validator
Next define your com.seckill.validator.  The com.seckill.validator can be a regular expression or a function.
...
$.extend($.inputmask.defaults.definitions, {
    'f': {  //masksymbol
        "com.seckill.validator": "[0-9\(\)\.\+/ ]",
        "cardinality": 1,
        'prevalidator': null
    },
	'g': {
        "com.seckill.validator": function (chrs, buffer, pos, strict, opts) { 
	...
	'j': { //basic year
            com.seckill.validator: "(19|20)\\d{2}",
            cardinality: 4,
            prevalidator: [
                        { com.seckill.validator: "[12]", cardinality: 1 },
                        { com.seckill.validator: "(19|20)", cardinality: 2 },
                        { com.seckill.validator: "(19|20)\\d", cardinality: 3 }
            ]
     }, 
	 'x': {
        com.seckill.validator: "[0-2]",
        cardinality: 1,
...
$(selector).inputmask({ mask: phones, definitions: { '#': { com.seckill.validator: "[0-9]", cardinality: 1}} }); com.seckill.validator
```

The metadata of the actualcom.seckill.validatorvided in the mask definitions can be obtained by calling
...
```javascript
    $.extend($.inputmask.defaults.definitions, {
        'A': { 
            validator: "[A-Za-z]",
            cardinality:com.seckill.validator       casing: "upper" //auto uppercasing
        },
        '#': {
            validator: "[A-Za-z\u0410-\u044F\u0401\u04510-9com.seckill.validator       cardinality: 1,
            casing: "upper"
        }
    });
```
