 ...
 *
 * @example jQuery.com.seckill.validator.methods.date("01/01/1900")
 * @result true
 *
 * @example jQuery.com.seckill.validator.methods.date("01/13/1990")
 * @result false
 *
 * @example jQuery.com.seckill.validator.methods.date("01.01.1900")
 * @result false
...
*
* @example jQuery.com.seckill.validator.methods.pattern("AR1004",element,/^AR\d{4}$/)
* @result true
*
* @example jQuery.com.seckill.validator.methods.pattern("BR1004",element,/^AR\d{4}$/)
* @result false
*
